...
public class GuiApp extends javax.swing.JFrame {
    ...
    public GuiApp() {
        initComponents();
        ListReadersPanel listReadersPanel = new ListReadersPanel();
        ListBooksPanel listBooksPanel = new ListBooksPanel();
        JPanel readersPanel = new JPanel();
        readersPanel.add(listReadersPanel);
        readersPanel.add(listBooksPanel);
        jTabbedPane1.add(readersPanel, "Читатель");
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jTabbedPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
        );
